<?php
  use Mpdf\Mpdf;
    ...
    //Seteo de PDF
        ...
        $name_doc = 'mantenimientoexterno_'.$doc_sinespacios.'.pdf';

        $mantenimientos = new models\MantenimientosClass();
        $arrayMantenimiento = $mantenimientos->getMantenimientoExternoByCod($codEmpresa, $codigoMNT); //Devuelve array de mantenimientos
        ...
        <header class="clearfix">
          ...
          <div id="contenedor_info">
                ...
                <div id="datos1">
                  ...
                  <div><span>CLIENTE: </span> '. $arrayMantenimiento['NombreCliente'] .'</div>
                  <div><span>TÈCNICO KAO: </span> '. $arrayMantenimiento['Encargado'] .'</div>
                  <div><span>DIRECCION: </span> '. $arrayMantenimiento['Direccion'] .'  </div>
                </div>
          </div>    
        </header>
        <main>
          <div>
            <table>
                ...
                <tboby>
                <tr>
                    <td class="service rownormal" colspan="2" style="font-size:20px;">'. $arrayMantenimiento['serieModelo'] .'</td>
                </tr>
