...
$(function() {
    ...
    $('.showInformePDF').on('click', function(event) {
        ...
        window.open(`views/modulos/ajax/API_documentos.php?action=generaInformeMantInternosPDF&fechaINI=${fechaInicial}&fechaFIN=${fechaFinal}&tiposDocs=${tiposDocs}&rucCliente=${rucAdvanced}&bodega=${bodega}`);
    ...
    $('.showInformeExcel').on('click', function(event) {
        ...
        window.open(`views/modulos/ajax/API_documentos.php?action=generaInformeMantInternosExcel&fechaINI=${fechaInicial}&fechaFIN=${fechaFinal}&tiposDocs=${tiposDocs}&rucCliente=${rucAdvanced}&bodega=${bodega}`);
    ...
    displayData: function (arrayResultados) {
        ...
        rows.forEach(row => {
            ...
            <tr class="">
                ...
                <td> (${row.codBodega})${row.nombreBodega} </td>
